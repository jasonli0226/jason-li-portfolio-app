...
## Task 9: ~~Experience timeline stagger~~ — SKIPPED

The Experience section is currently disabled via commit `be36c0e` (commented out of nav and routes). Motion work on Experience is deferred until the section is re-enabled; this task is dropped from scope.
...
- Experience: section is intentionally disabled — skip.
